# Gentoo support overlay for RuyiSDK

This is an overlay providing various RuyiSDK products, for Gentoo users'
convenience.

> [!NOTE]
> While `ruyi` likely works well on Gentoo, Gentoo is *not* an [officially supported]
> distribution by the RuyiSDK product. Specifically, binary packages
...
[officially supported]: https://ruyisdk.org/en/docs/Other/platform-support/
